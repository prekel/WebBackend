...
import { CartDto, CustomerDto, ProductDto } from "../MyStore.Dto/Shop.js";
...
export function Product$reflection() {
    return record_type("MyStore.Domain.PublicTypes.Product", [], Product, () => [["ProductId", int32_type], ["Name", string_type], ["Description", string_type], ["Price", class_type("System.Decimal")]]);
}
...
export function Customer$reflection() {
    return record_type("MyStore.Domain.PublicTypes.Customer", [], Customer, () => [["CustomerId", int32_type], ["FirstName", string_type], ["LastName", option_type(string_type)], ["Honorific", option_type(string_type)], ["Email", string_type], ["UserId", option_type(string_type)], ["CurrentCartId", option_type(int32_type)]]);
}
...
export function Cart$reflection() {
    return record_type("MyStore.Domain.PublicTypes.Cart", [], Cart, () => [["CartId", int32_type], ["IsPublic", bool_type], ["OwnerCustomerId", option_type(int32_type)]]);
}
