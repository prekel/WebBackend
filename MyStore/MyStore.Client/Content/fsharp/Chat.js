...
import { ofArray, singleton as singleton_1, reverse, empty, cons } from "./.fable/fable-library.3.1.11/List.js";
...
import { map as map_2, choose, addRangeInPlace } from "./.fable/fable-library.3.1.11/Array.js";
...
import { some, map as map_1, value as value_18 } from "./.fable/fable-library.3.1.11/Option.js";
...
export function ChatDisplay(st) {
    const children = toList(delay(() => {
        let value;
        return append(singleton((value = toText(interpolate("%A%P()", [st.chat])), createElement("p", {
            children: [value],
        }))), delay(() => {
            let value_1;
            return append(singleton((value_1 = toText(interpolate("Ticket: %A%P()", [st.chat.Ticket])), createElement("p", {
                children: [value_1],
            }))), delay(() => append(singleton(createElement("p", {
                children: ["Answers:"],
            })), delay(() => append(map((i) => {
                const value_3 = toText(interpolate("%A%P()", [i]));
                return createElement("p", {
                    children: [value_3],
                });
            }, st.chat.Answers), delay(() => append(singleton(createElement("p", {
                children: ["Questions: "],
            })), delay(() => map((i_1) => {
                const value_5 = toText(interpolate("%A%P()", [i_1]));
                return createElement("p", {
                    children: [value_5],
                });
            }, st.chat.Questions)))))))));
                ...
                return Array.from(((typeof input_2) === "string") ? (equals(input_2, "") ? [] : (() => {
                    ...
                    try {
                        return choose((m) => {
                            ...
                            const msgType_1 = value_18(map_1((arg00_5) => Convert_fromJson(arg00_5, createTypeInfo(enum_type("Fable.SignalR.Messages.MessageType", int32_type, [["Invocation", 1], ["StreamItem", 2], ["Completion", 3], ["StreamInvocation", 4], ["CancelInvocation", 5], ["Ping", 6], ["Close", 7]]))), SimpleJson_readPath(singleton_1("type"), parsedRaw))) | 0;
                            switch (msgType_1) {
                                case 1: {
                                    let _arg1_1;
                                    try {
...
export function Chat(chatModel) {
    const state = new State(Ticket_ToDomain_5519A0CB(chatModel.ticket), ofArray(map_2((arg00_1) => Question_ToDomain_Z758746DF(arg00_1), chatModel.questions)), ofArray(map_2((arg00_2) => Answer_ToDomain_6B06E833(arg00_2), chatModel.answers)), new Status(2));
    if ((() => {
        try {
